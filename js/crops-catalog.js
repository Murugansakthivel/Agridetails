/* Agridetails — full crop catalog: Vegetables & Fruits (EN / தமிழ் / हिंदी)
   Names supplied by site owner. Base prices for 31 high-traffic crops were
   updated from real Koyambedu wholesale market (Chennai) reports, Aug 24-27
   2026 — see dtnext.in and daatacenter.com Koyambedu price bulletins.
   Remaining crops use estimated wholesale levels pending real data.
   ₹ per quintal; live mode replaces all of this with AGMARKNET data. */
const CROP_CATALOG = {
  vegetables: [
    { en: 'Potato',            ta: 'உருளைக்கிழங்கு',        hi: 'आलू',              base: 3500 },
    { en: 'Onion',             ta: 'வெங்காயம்',             hi: 'प्याज़',            base: 6000 },
    { en: 'Tomato',            ta: 'தக்காளி',               hi: 'टमाटर',            base: 2000 },
    { en: 'Brinjal',           ta: 'கத்தரிக்காய்',          hi: 'बैंगन',            base: 4000 },
    ...
    { en: 'Carrot',            ta: 'கேரட்',                hi: 'गाजर',             base: 7000 },
    { en: 'Beetroot',          ta: 'பீட்ரூட்',              hi: 'चुकंदर',           base: 6000 },
    ...
    { en: 'Green Peas',        ta: 'பச்சைப் பட்டாணி',       hi: 'हरी मटर',          base: 18000 },
    { en: 'Green Beans',       ta: 'பீன்ஸ்',               hi: 'हरी फलियाँ',       base: 8000 },
    { en: 'Cluster Beans',     ta: 'கொத்தவரங்காய்',        hi: 'ग्वार फली',        base: 2400 },
    { en: 'Capsicum',          ta: 'குடைமிளகாய்',          hi: 'शिमला मिर्च',      base: 5000 },
    { en: 'Green Chilli',      ta: 'பச்சை மிளகாய்',        hi: 'हरी मिर्च',        base: 6000 },
    { en: 'Cucumber',          ta: 'வெள்ளரிக்காய்',        hi: 'खीरा',             base: 1200 },
    { en: 'Bottle Gourd',      ta: 'சுரைக்காய்',           hi: 'लौकी',             base: 1000 },
    { en: 'Bitter Gourd',      ta: 'பாகற்காய்',            hi: 'करेला',            base: 5000 },
    { en: 'Ridge Gourd',       ta: 'பீர்க்கங்காய்',        hi: 'तुरई',             base: 1400 },
    { en: 'Snake Gourd',       ta: 'புடலங்காய்',           hi: 'चिचिंडा',          base: 3000 },
    { en: 'Ivy Gourd',         ta: 'கோவைக்காய்',           hi: 'कुंदरू',           base: 2000 },
    { en: 'Pumpkin',           ta: 'பூசணிக்காய்',          hi: 'कद्दू',            base: 900 },
    { en: 'Drumstick',         ta: 'முருங்கைக்காய்',       hi: 'सहजन',             base: 5000 },
    ...
    { en: 'Garlic',            ta: 'பூண்டு',               hi: 'लहसुन',            base: 24000 },
    { en: 'Ginger',            ta: 'இஞ்சி',                hi: 'अदरक',             base: 18000 },
  ...
  fruits: [
    ...
    { en: 'Banana',          ta: 'வாழைப்பழம்',        hi: 'केला',          base: 6500 },
    { en: 'Apple',           ta: 'ஆப்பிள்',           hi: 'सेब',           base: 16000 },
    { en: 'Orange',          ta: 'ஆரஞ்சு',            hi: 'संतरा',         base: 7000 },
    { en: 'Sweet Lime',      ta: 'சாத்துக்குடி',       hi: 'मौसंबी',        base: 6000 },
    { en: 'Lemon',           ta: 'எலுமிச்சை',         hi: 'नींबू',         base: 25000 },
    { en: 'Grapes',          ta: 'திராட்சை',          hi: 'अंगूर',         base: 9000 },
    { en: 'Pomegranate',     ta: 'மாதுளை',            hi: 'अनार',          base: 16000 },
    { en: 'Guava',           ta: 'கொய்யாப்பழம்',      hi: 'अमरूद',         base: 2200 },
    { en: 'Papaya',          ta: 'பப்பாளி',           hi: 'पपीता',         base: 2500 },
    { en: 'Watermelon',      ta: 'தர்பூசணி',          hi: 'तरबूज़',        base: 3000 },
    { en: 'Muskmelon',       ta: 'முலாம்பழம்',        hi: 'खरबूजा',        base: 1200 },
    { en: 'Pineapple',       ta: 'அன்னாசிப்பழம்',     hi: 'अनानास',        base: 7000 },
    { en: 'Jackfruit',       ta: 'பலாப்பழம்',         hi: 'कटहल',          base: 15000 },
    { en: 'Coconut',         ta: 'தேங்காய்',          hi: 'नारियल',        base: 2500 },
    { en: 'Chikoo',          ta: 'சப்போட்டா',         hi: 'चीकू',          base: 5000 },
    { en: 'Custard Apple',   ta: 'சீத்தாப்பழம்',      hi: 'शरीफा',         base: 8000 },
    ...
    { en: 'Strawberry',      ta: 'ஸ்ட்ராபெர்ரி',      hi: 'स्ट्रॉबेरी',    base: 25000 },
    { en: 'Kiwi',            ta: 'கிவி',              hi: 'कीवी',          base: 11000 },
    { en: 'Avocado',         ta: 'வெண்ணெய் பழம்',     hi: 'एवोकाडो',       base: 11000 },
    ...
    { en: 'Cherry',          ta: 'செர்ரி',            hi: 'चेरी',          base: 40000 },
